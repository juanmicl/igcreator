...
class create {
	public function register($username, $password, $email, $firstname){
		...
		CURLOPT_POSTFIELDS => "email=$email&password=$password&username=$username&first_name=$firstname&client_id=".randstring('28')."&seamless_login_enabled=1&gdpr_s=%5B0%2C2%2C0%2Cnull%5D&tos_version=eu&opt_into_one_tap=false",
